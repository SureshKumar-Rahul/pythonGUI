...
Nyquist frequency(low, high) = 0.5 * fs
'''
df = pd.read_csv('Data/Music/Subject 0/track0.mp3/data_2024-05-12_09-21-16.csv')
band_pass_eeg = butter_bandpass_filter(data=df[0:15], lowcut=1, highcut=50, fs=250, order=3)
